...
#define RF_STATUS 1 //1单发,0单收 
//#define ENABLE_ANTENNA_SWITCH   //当手里是我司模块300H，300P1 300P4 这些硬件上用gpio1 gpio2当电子开关的，需要打开这个宏定义；如果硬件设计是直连匹配电路，或者使用我司RFM300模块的则要注释掉这个宏定义
